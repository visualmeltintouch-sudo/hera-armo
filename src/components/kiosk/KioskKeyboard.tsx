...
function Key({
  ...
  return (
    <button
      ...
      onClick={onPress}
      className={`h-[62px] ${wide ? "w-[72px] shrink-0" : "flex-1"} rounded-2xl text-lg font-semibold transition-transform active:scale-90 select-none ${
...
export function KioskKeyboard({
  ...
  return (
    <div
      ...
      aria-hidden={!visible}
    >
      <div className="w-full max-w-[1080px] bg-card rounded-t-[32px] shadow-2xl px-6 pt-4 pb-7">
        <div className="flex items-center justify-between mb-3 px-2">
          ...
          <button
            ...
            onMouseDown={(e) => e.preventDefault()}
            onClick={close}
            className="text-sm font-bold text-primary px-5 py-2 rounded-full border-2 border-primary"
          >
            Fine
          </button>
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-2 px-[26px]">
          ...
          <div className="flex gap-2 mt-1">
            ...
            <button
              ...
              onMouseDown={(e) => e.preventDefault()}
              onClick={space}
              className="flex-[3] h-[62px] rounded-2xl bg-muted text-foreground font-semibold text-base select-none active:scale-[0.98] transition-transform"
            >
              spazio
            </button>
            <Key label="-" onPress={() => press("-")} />
