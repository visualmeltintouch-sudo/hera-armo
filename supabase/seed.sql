...
(v_event_id, 'young', 5,
 ...
 'Clima acceso e pace fatta col mondo', '❄️', 0, 0, 1),

(v_event_id, 'young', 6,
 'In cucina il tuo alter ego è:',
 '"Con quello che c''è creo qualcosa"', '♻️', 2, 0, 0,
 '"Pochi step, risultato garantito"', '⏱️', 0, 0, 1),

(v_event_id, 'young', 7,
 'Al supermercato cosa ti conquista subito?',
 'Versione essenziale: meno packaging possibile', '📦', 2, 0, 0,
 'Versione smart: pronto e senza sbatti', '⚙️', 0, 0, 1),
...
(v_event_id, 'young', 10,
 ...
 'Una shopper che appare sempre al momento giusto', '🛍️', 2, 0, 0,
...
(v_event_id, 'young', 12,
 ...
 'Ombra, tende e corrente naturale', '☀️', 2, 0, 0,
 'Clima acceso, ma impostato bene', '❄️', 0, 0, 1),
...
(v_event_id, 'young', 18,
 ...
 'Scoprire nuovi sentieri', '⛰️', 2, 0, 0,
...
(v_event_id, 'classic', 5,
 ...
 'Accendo il climatizzatore', '❄️', 0, 0, 1),

(v_event_id, 'classic', 6,
 'In cucina sei più tipo…',
 'Uso tutto, zero sprechi', '♻️', 2, 0, 0,
 'Cucino veloce e pratico', '⏱️', 0, 0, 1),
...
(v_event_id, 'classic', 10,
 ...
 'Portare una shopper riutilizzabile', '🛍️', 2, 0, 0,
