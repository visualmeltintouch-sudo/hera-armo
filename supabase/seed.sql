...
INSERT INTO hera_armo_questions (event_id, age_group, sort_order, question_text, option_a_text, option_a_icon, option_a_verde, option_a_ciano, option_a_magenta, option_b_text, option_b_icon, option_b_verde, option_b_ciano, option_b_magenta) VALUES
(v_event_id, 'young', 1,
 'Esci per una giornata infinita. Prima cosa che controlli?',
 'Che la borraccia sia piena', '💧', 4, 6, 3,
 'Che ci sia sempre un posto dove prendere qualcosa al volo', '⚡', 3, 4, 6),

(v_event_id, 'young', 2,
 'Devi fare un tragitto breve. Vai in modalità:',
 'Cammino e mi godo il tragitto', '🌱', 6, 4, 3,
 'Bici e si ottimizza il tempo', '🚴', 4, 3, 6),

(v_event_id, 'young', 3,
 'Weekend libero, nessun piano. Dove ti ritrovi?',
 'Coperta stesa e zero notifiche al parco', '🌿', 6, 4, 3,
 'Acqua, sole e giornata vista mare/vista montagne', '🌊', 4, 6, 3),

(v_event_id, 'young', 4,
 'Allenamento ideale?',
 'Fuori, aria addosso e si resetta il cervello', '🌳', 6, 4, 3,
 'Playlist giusta e modalità performance ON', '🎧', 4, 3, 6),

(v_event_id, 'young', 5,
 'Torni a casa, fuori ci sono 35°.',
 'Finestre aperte e strategia anti-caldo', '🪟', 6, 3, 4,
 'Clima acceso e pace fatta col mondo', '❄️', 4, 3, 6),

(v_event_id, 'young', 6,
 'In cucina il tuo alter ego è:',
 '"Con quello che c''è creo qualcosa"', '♻️', 6, 4, 3,
 '"Pochi step, risultato garantito"', '⏱️', 4, 3, 6),

(v_event_id, 'young', 7,
 'Al supermercato cosa ti conquista subito?',
 'Versione essenziale: meno packaging possibile', '📦', 6, 4, 3,
 'Versione smart: pronto e senza sbatti', '⚙️', 4, 3, 6),

(v_event_id, 'young', 8,
 'Giornata calda. Cosa ti resetta davvero?',
 'Un posto fresco all''aperto', '🌲', 6, 4, 3,
 'Doccia veloce e si riparte', '🚿', 3, 6, 4),

(v_event_id, 'young', 9,
 'Quando cucini il tuo superpotere è:',
 'Far sparire gli avanzi (nel senso buono)', '🥬', 6, 4, 3,
 'Usare esattamente quello che serve', '💧', 4, 6, 3),

(v_event_id, 'young', 10,
 'Giornata fuori casa: nel tuo kit base c''è:',
 'Una shopper che appare sempre al momento giusto', '🛍️', 6, 4, 3,
 'La borraccia che si ricarica ovunque', '🚰', 4, 6, 3),

(v_event_id, 'young', 11,
 'Appena entri in casa fai automaticamente:',
 'Cambio aria totale', '💨', 6, 3, 4,
 'Check rapido di luci e dispositivi', '💡', 4, 3, 6),

(v_event_id, 'young', 12,
 'Estate in città: il tuo mood è:',
 'Ombra, tende e sopravvivenza naturale', '☀️', 6, 3, 4,
 'Clima sì, ma settato con criterio', '❄️', 4, 3, 6),

(v_event_id, 'young', 13,
 'Quando compri qualcosa pensi:',
 '"Serve davvero tutto questo imballaggio?"', '📉', 6, 4, 3,
 '"Se arriva domani ancora meglio"', '🚚', 4, 3, 6),

(v_event_id, 'young', 14,
 'Oggetto rotto. Prima reazione:',
 'Aspetta, magari si recupera', '🔧', 6, 3, 4,
 'Upgrade immediato e si va avanti', '✨', 4, 3, 6),

(v_event_id, 'young', 15,
 'In cucina ottimizzi soprattutto:',
 'Acqua e piccoli gesti che fanno differenza', '💧', 4, 6, 3,
 'Tempi, consumi e organizzazione', '🔥', 3, 4, 6),

(v_event_id, 'young', 16,
 'Prima di lasciare la spiaggia:',
 'Controllo finale: nessuna traccia del mio passaggio', '🧹', 6, 4, 3,
 'Doccia veloce e modalità ritorno', '🚿', 3, 4, 6),

(v_event_id, 'young', 17,
 'Borsa mare: oggetto non negoziabile:',
 'Borraccia termica sempre pronta', '🧊', 4, 6, 3,
 'Power bank perché il telefono deve vivere', '🔋', 4, 3, 6),

(v_event_id, 'young', 18,
 'In montagna sei quello che:',
 'Prende il sentiero che incuriosisce di più', '⛰️', 6, 4, 3,
 'Parte con batteria al 100% e mappe scaricate', '📱', 4, 3, 6),

(v_event_id, 'young', 19,
 'In hotel / casa vacanza il tuo gesto automatico è:',
 'Doccia breve senza pensarci troppo', '🚿', 4, 6, 3,
 'Spegnere tutto quando esci', '💡', 4, 3, 6),

(v_event_id, 'young', 20,
 'Oggetto che entra SEMPRE nello zaino:',
 'Qualcosa che evita acquisti inutili dopo', '🛍️', 6, 4, 3,
 'Qualcosa che ti dà energia subito', '⚡', 4, 3, 6);
...
(v_event_id, 'classic', 1,
 ...
 'Borraccia riutilizzabile', '💧', 4, 6, 3,
 'Bottiglietta al volo', '🥤', 3, 4, 6),

(v_event_id, 'classic', 2,
 'Per uno spostamento breve scegli più spesso…',
 'Vado a piedi', '🚶', 6, 4, 3,
 'Prendo la bici', '🚴', 4, 3, 6),

(v_event_id, 'classic', 3,
 'Weekend libero: cosa ti chiama di più?',
 'Picnic al parco', '🌿', 6, 4, 3,
 'Giornata al mare', '🌊', 4, 6, 3),

(v_event_id, 'classic', 4,
 'Allenamento ideale?',
 'Sport all''aria aperta', '🌳', 6, 4, 3,
 'Palestra con playlist giusta', '🎵', 4, 3, 6),

(v_event_id, 'classic', 5,
 'Estate in città: prima mossa anti-caldo?',
 'Apro tutto e creo corrente', '💨', 6, 3, 4,
 'Accendo il climatizzatore', '❄️', 4, 3, 6),

(v_event_id, 'classic', 6,
 'In cucina sei più tipo…',
 'Uso tutto, zero sprechi', '♻️', 6, 4, 3,
 'Cucino veloce e pratico', '⏱️', 4, 3, 6),

(v_event_id, 'classic', 7,
 'Quando fai la spesa ti attira di più…',
 'Prodotto sfuso o con meno packaging', '📦', 6, 4, 3,
 'Prodotto pronto, comodo e smart', '⚙️', 4, 3, 6),

(v_event_id, 'classic', 8,
 'Durante una giornata calda, cosa ti rigenera di più?',
 'Stare all''ombra in un parco', '🌳', 6, 4, 3,
 'Una doccia fresca e veloce', '🚿', 3, 6, 4),

(v_event_id, 'classic', 9,
 'In cucina, cosa ti viene più naturale?',
 'Recuperare gli avanzi', '🥬', 6, 4, 3,
 'Usare solo l''acqua che serve', '💧', 4, 6, 3),

(v_event_id, 'classic', 10,
 'Per una giornata fuori, quale abitudine ti rappresenta di più?',
 'Portare una shopper riutilizzabile', '🛍️', 6, 4, 3,
 'Riempire la borraccia quando puoi', '🚰', 4, 6, 3),

(v_event_id, 'classic', 11,
 'A casa, qual è il tuo gesto automatico?',
 'Aprire le finestre per cambiare aria', '🪟', 6, 3, 4,
 'Spegnere luci e dispositivi inutilizzati', '💡', 4, 3, 6),

(v_event_id, 'classic', 12,
 'Estate in città: come affronti il caldo?',
 'Ombra, tende e corrente naturale', '☀️', 6, 3, 4,
 'Clima acceso, ma impostato bene', '❄️', 4, 3, 6),

(v_event_id, 'classic', 13,
 'Quando compri qualcosa, cosa ti convince di più?',
 'Meno imballaggi', '📉', 6, 4, 3,
 'Spedizione rapida', '🚚', 4, 3, 6),

(v_event_id, 'classic', 14,
 'Se qualcosa si rompe, cosa pensi per primo?',
 'Provo a ripararlo', '🔧', 6, 3, 4,
 'Lo sostituisco con qualcosa di più efficiente', '✨', 4, 3, 6),

(v_event_id, 'classic', 15,
 'In cucina, cosa ottimizzi di più?',
 'Acqua per lavare e cucinare', '💧', 4, 6, 3,
 'Tempi e consumi dei fornelli', '🔥', 3, 4, 6),

(v_event_id, 'classic', 16,
 'In spiaggia, prima di andare via, cosa fai?',
 'Controllo di non lasciare nulla sulla sabbia', '🧹', 6, 4, 3,
 'Mi faccio la doccia al lido', '🚿', 3, 4, 6),

(v_event_id, 'classic', 17,
 'Giornata al mare: cosa non può mancare nella tua borsa?',
 'Borraccia termica sempre piena', '🧊', 4, 6, 3,
 'Power bank carico per musica e foto', '🔋', 4, 3, 6),

(v_event_id, 'classic', 18,
 'In montagna, durante una camminata, cosa ti rappresenta di più?',
 'Scoprire nuovi sentieri', '⛰️', 6, 4, 3,
 'Usare app, mappe e telefono ben carichi', '📱', 4, 3, 6),

(v_event_id, 'classic', 19,
 'In hotel o in casa vacanza, qual è il tuo gesto automatico?',
 'Sprecare meno acqua durante la doccia', '🚿', 4, 6, 3,
 'Spegnere luci e aria quando esci', '💡', 4, 3, 6),

(v_event_id, 'classic', 20,
 'Zaino da vacanza: cosa metti sempre dentro?',
 'Schiscetta per il pranzo', '🥗', 6, 4, 3,
 'Comprare un drink energetico', '⚡', 4, 3, 6);
